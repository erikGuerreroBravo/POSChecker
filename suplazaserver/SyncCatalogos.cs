...
// Type: POSChecker.suplazaserver.SyncCatalogos
...
namespace POSChecker.suplazaserver
{
  ...
  {
    public SyncCatalogos() => this.Url = "http://reformaserver:8732/SyncPOS.SyncCatalogos.svc";
    ...
    [SoapDocumentMethod("http://tempuri.org/ISyncCatalogos/getItemsForKiosk", ParameterStyle = SoapParameterStyle.Wrapped, RequestNamespace = "http://tempuri.org/", ResponseNamespace = "http://tempuri.org/", Use = SoapBindingUse.Literal)]
    [return: XmlArray(IsNullable = true)]
    [return: XmlArrayItem(Namespace = "http://schemas.datacontract.org/2004/07/SyncPOS.domain")]
    public articulo[] getItemsForKiosk([XmlElement(IsNullable = true)] string lastChangeDateTime) => (articulo[]) this.Invoke(nameof (getItemsForKiosk), new object[1]
    {
      (object) lastChangeDateTime
    })[0];

    public IAsyncResult BegingetItemsForKiosk(
      string lastChangeDateTime,
      AsyncCallback callback,
      object asyncState)
    {
      return this.BeginInvoke("getItemsForKiosk", new object[1]
      {
        (object) lastChangeDateTime
      }, callback, asyncState);
    }

    public articulo[] EndgetItemsForKiosk(IAsyncResult asyncResult) => (articulo[]) this.EndInvoke(asyncResult)[0];

    [SoapDocumentMethod("http://tempuri.org/ISyncCatalogos/getOffersforKiosk", ParameterStyle = SoapParameterStyle.Wrapped, RequestNamespace = "http://tempuri.org/", ResponseNamespace = "http://tempuri.org/", Use = SoapBindingUse.Literal)]
    [return: XmlArray(IsNullable = true)]
    [return: XmlArrayItem(Namespace = "http://schemas.datacontract.org/2004/07/SyncPOS.domain")]
    public oferta[] getOffersforKiosk([XmlElement(IsNullable = true)] string lastChangeDateTime) => (oferta[]) this.Invoke(nameof (getOffersforKiosk), new object[1]
    {
      (object) lastChangeDateTime
    })[0];

    public IAsyncResult BegingetOffersforKiosk(
      string lastChangeDateTime,
      AsyncCallback callback,
      object asyncState)
    {
      return this.BeginInvoke("getOffersforKiosk", new object[1]
      {
        (object) lastChangeDateTime
      }, callback, asyncState);
    }

    public oferta[] EndgetOffersforKiosk(IAsyncResult asyncResult) => (oferta[]) this.EndInvoke(asyncResult)[0];
  }
}
